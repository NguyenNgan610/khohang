...
class ProductController extends Controller
{
    ...
    {
        //
        $products = Product::with(['category', 'user', 'unit', 'location']);
        ...
        if ($request->p_location_id) {
            $products = $products->where('p_location_id', $request->p_location_id);
        }
