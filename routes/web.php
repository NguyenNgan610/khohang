...
Route::group(['prefix' => 'system', 'namespace' => 'Backend', 'middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'customers'], function () {
        Route::get('/', 'CustomerController@index')->name('get.list.customer');
        Route::get('/create', 'CustomerController@create')->name('get.create.customer');
        Route::post('/create', 'CustomerController@store');
        Route::get('/update/{id}', 'CustomerController@edit')->name('get.update.customer');
        Route::post('/update/{id}', 'CustomerController@update');
        Route::get('/delete/{id}', 'CustomerController@delete')->name('get.delete.customer');

        Route::post('/import', 'CustomerController@import')->name('post.import.customer');
    });
    ...
    Route::group(['prefix' => 'locations'], function () {
        Route::get('/', 'LocationController@index')->name('get.list.locations')->middleware('permission:danh-sach-vi-tri|toan-bo-he-thong');
        Route::get('/create', 'LocationController@create')->name('get.create.locations')->middleware('permission:them-vi-tri|toan-bo-he-thong');
        Route::post('/create', 'LocationController@store');
        Route::get('/update/{id}', 'LocationController@edit')->name('get.update.locations')->middleware('permission:chinh-sua-vi-tri|toan-bo-he-thong');
        Route::post('/update/{id}', 'LocationController@update');
        Route::get('/delete/{id}', 'LocationController@delete')->name('get.delete.locations')->middleware('permission:xoa-vi-tri|toan-bo-he-thong');
    });

    Route::group(['prefix' => 'box'], function () {
        Route::get('/', 'LocationBoxController@index')->name('get.list.box')->middleware('permission:danh-sach-o-vi-tri|toan-bo-he-thong');
        Route::get('/create', 'LocationBoxController@create')->name('get.create.box')->middleware('permission:them-o-vi-tri|toan-bo-he-thong');
        Route::post('/create', 'LocationBoxController@store');
        Route::get('/update/{id}', 'LocationBoxController@edit')->name('get.update.box')->middleware('permission:chinh-sua-o-vi-tri|toan-bo-he-thong');
        Route::post('/update/{id}', 'LocationBoxController@update');
        Route::get('/delete/{id}', 'LocationBoxController@delete')->name('get.delete.box')->middleware('permission:xoa-o-vi-tri|toan-bo-he-thong');

        Route::post('/ajax', 'LocationBoxController@ajaxGetBox')->name('ajax.get.box');
    });
    ...
    Route::group(['prefix' => 'product_warehousing_detail'], function () {
        Route::get('/{id}', 'ProductWarehousingDetailController@index')->name('get.list.product.warehousing.detail');
        Route::get('/export/{id}', 'ProductWarehousingDetailExportController@index')->name('get.list.product.warehousing.export.detail');
        Route::get('/update/{id}', 'ProductWarehousingDetailController@edit')->name('get.list.product.warehousing.update');
        Route::post('/update/{id}', 'ProductWarehousingDetailController@update');
        Route::get('/delete/{id}', 'ProductWarehousingDetailController@delete')->name('delete.product.warehousing.detail');

        Route::post('list/products/imei', 'ProductWarehousingDetailController@getListImei')->name('get.list.imei');
    });
    ...
    Route::group(['prefix' => 'warranty'], function () {
        Route::get('/{id}', 'ExportProductWarehousingController@warranty')->name('get.warranty');
    });
    ...
    Route::group(['prefix' => 'transport-method'], function () {
        Route::get('/', 'TransportMethodController@index')->name('get.list.transport.method')->middleware('permission:|toan-bo-he-thong');
        Route::get('/create', 'TransportMethodController@create')->name('get.create.transport.method')->middleware('permission:|toan-bo-he-thong');
        Route::post('/create', 'TransportMethodController@store');
        Route::get('/update/{id}', 'TransportMethodController@edit')->name('get.update.transport.method')->middleware('permission:|toan-bo-he-thong');
        Route::post('/update/{id}', 'TransportMethodController@update');
        Route::get('/delete/{id}', 'TransportMethodController@delete')->name('get.delete.transport.method')->middleware('permission:|toan-bo-he-thong');
    });
});
