    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree" style="margin-top: 20px;">
                ...
                <li class="header" style="text-transform: uppercase;">Thiết lập dữ liệu sản phẩm</li>
                <li class="treeview {!! (isset($c_menu) || isset($unit_menu) || isset($pro_menu) || isset($box_active) || isset($location_active))  ? 'active menu-open' : '' !!} " style="height: auto;">
                    <a href="#">
                    ...
                    <ul class="treeview-menu" style="display: {!! (isset($c_menu) || isset($unit_menu) || isset($pro_menu) || isset($box_active) || isset($location_active)) ? 'block' : 'none' !!}">
                        ...
                        <li {!! isset($location_active) ? "class='active'" : '' !!}><a href="{!! route('get.list.locations') !!}"><i class="fa fa-circle-o"></i> <span>Vị trí</span></a></li>
                        <li {!! isset($box_active) ? "class='active'" : '' !!}><a href="{!! route('get.list.box') !!}"><i class="fa fa-circle-o"></i> <span>Ô vị trí</span></a></li>
                        
                    </ul>
                </li>

                <li {!! isset($sup_menu) ? "class='active'" : '' !!}><a href="{!! route('get.list.suppliers') !!}"><i class="fa fa-fw fa-cubes"></i> <span>Nhà cung cấp</span></a></li>
                <li {!! isset($customer_menu) ? "class='active'" : '' !!}><a href="{!! route('get.list.customer') !!}"><i class="fa fa-fw fa-cubes"></i> <span>Khách hàng</span></a></li>

                <li {!! isset($transport_method) ? "class='active'" : '' !!}>
                    <a href="{!! route('get.list.transport.method') !!}">
                ...
                <li {!! isset($warehouse) ? "class='active'" : '' !!}><a href="{!! route('get.list.warehouse') !!}"><i class="fa fa-fw fa-th-large"></i> <span>Dữ liệu tồn kho</span></a></li>
                <li class="header" style="text-transform: uppercase;">Báo cáo thống kê</li>
                <li {!! isset($statistical) ? "class='active'" : '' !!}><a href="{!! route('statistical') !!}"><i class="fa fa-fw fa-pie-chart"></i> <span>Thống kê nhập xuất tồn kho</span></a></li>
