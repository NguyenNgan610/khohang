<div class="col-md-8 default">
    ...
    <p><b>Trạng thái nhập hàng : {{ $warehousing->w_note  }}</b></p>
    @endif
    ...
    <tbody>
        ...
        @foreach($products as $key => $product)
            <tr>
                ...
                <td style="vertical-align: middle">{{ $product->supplier->s_name }}</td>
                <td style="vertical-align: middle">{{ $product->pw_total_number }}</td>
                ...
                <td style="vertical-align: middle">{{ $product->pw_manufacturing_date }}</td>
        ...
        @endforeach
            <tr>
                <td colspan="7" class="text-center"> <b>Tổng giá trị</b> </td>
