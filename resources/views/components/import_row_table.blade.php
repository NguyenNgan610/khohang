<tr location="{{ $location }}" class="product_{{ $location }}">
    ...
    <td>
        @if (!$type)
            <select name="list_imei_sp[{{ $location }}][]" id="" class="form-control select list_imei_sp list_imei_sp_{{ $location }}" multiple required>
            </select>
        @else
            <input type="text" class="form-control expiry_date" name="list_imei_sp[{{ $location }}]" value="">
        @endif
    </td>
    <td>
